...
namespace Tic_Tac_Toe
{
    public partial class Form1 : Form
    {
        ...
        {
            MessageBox.Show("This is tik tac toe, player one is X and player two is O");//About Section
        }
        ...
        private void updateWinStreak(string winner)
        {
            ...
            winStreakLabel.Text = String.Format($"{winner} is on a win streak of {Math.Abs(winStreak)}");
        }
